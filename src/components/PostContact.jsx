...
export default function PostContact({ title }) {
  ...
  async function onSubmit(ev) {
    ...
    else { form.reset(); setConsent(false); setErrors({}); setStatus({ ok: true, msg: b.ctaSent }); trackEvent('generate_lead', { form: 'blog', source: title }) }
  }
    ...
    <section className="post-cta">
      <div className="post-cta-head">
        ...
        <a className="btn wa-inline" href={waHref} target="_blank" rel="noopener noreferrer"
           onClick={() => trackEvent('contact_whatsapp', { source: `blog:${title}` })}>
