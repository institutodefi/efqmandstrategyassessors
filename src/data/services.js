...
export const SERVICES = {
  en: {
    ...
    hub: {
      ...
      wa: 'WhatsApp', request: 'Request', requestFull: 'Request this service',
      waMsg: 'Hello, I would like to talk to an assessor about your services.',
      waService: 'Hello, I am interested in {service}. Could you tell me more?',
      reqEyebrow: 'Request a service',
      reqTitleA: 'Tell us what you ', reqStrong: 'need', reqTitleB: '',
      reqLead: 'Send the form and we will reply within one business day — usually with a short call to understand your situation before anything else. Prefer to talk now? Use WhatsApp.',
      reqService: 'Service of interest', reqAny: 'General enquiry',
    },
    consultancy: {
  ...
  ar: {
    ...
    hub: {
      ...
      wa: 'واتساب', request: 'طلب', requestFull: 'اطلب هذه الخدمة',
      waMsg: 'مرحباً، أودّ التحدّث إلى مقيّم بخصوص خدماتكم.',
      waService: 'مرحباً، أنا مهتمّ بـ {service}. هل يمكنكم إخباري بالمزيد؟',
      reqEyebrow: 'اطلب خدمة',
      reqTitleA: 'أخبرونا بما ', reqStrong: 'تحتاجون', reqTitleB: '',
      reqLead: 'أرسلوا النموذج وسنردّ خلال يوم عمل واحد — غالباً بمكالمة قصيرة لفهم وضعكم قبل أي شيء آخر. تفضّلون الحديث الآن؟ استخدموا واتساب.',
      reqService: 'الخدمة محلّ الاهتمام', reqAny: 'استفسار عام',
    },
    consultancy: {
