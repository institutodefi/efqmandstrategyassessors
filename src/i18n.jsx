...
export const STRINGS = {
  en: {
    ...
    contact: {
      ...
      fName: 'Name', fFirstName: 'First name', fLastName: 'Last name', fEmail: 'Email', fOrg: 'Company', fMsg: 'How can we help?',
  ...
  ar: {
    ...
    contact: {
      ...
      fName: 'الاسم', fFirstName: 'الاسم الأول', fLastName: 'اسم العائلة', fEmail: 'البريد الإلكتروني', fOrg: 'الشركة', fMsg: 'كيف يمكننا المساعدة؟',
