...
export const STRINGS = {
  en: {
    ...
    contact: {
      ...
      fName: 'Name', fFirstName: 'First name', fLastName: 'Last name', fEmail: 'Email', fOrg: 'Organisation', fMsg: 'How can we help?',
    ...
    auth: {
      ...
      fullName: 'Full name', firstName: 'First name', lastName: 'Last name', email: 'Email', password: 'Password',
  ...
  ar: {
    ...
    contact: {
      ...
      fName: 'الاسم', fFirstName: 'الاسم الأول', fLastName: 'اسم العائلة', fEmail: 'البريد الإلكتروني', fOrg: 'المؤسسة', fMsg: 'كيف يمكننا المساعدة؟',
    ...
    auth: {
      ...
      fullName: 'الاسم الكامل', firstName: 'الاسم الأول', lastName: 'اسم العائلة', email: 'البريد الإلكتروني', password: 'كلمة المرور',
