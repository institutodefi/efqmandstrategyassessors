...
export const SOCIAL = [
  { name: 'LinkedIn', icon: 'linkedin', url: 'https://www.linkedin.com/company/efqm-and-strategy-assessors-dubai' },
  { name: 'X', icon: 'x', url: 'https://x.com/efqmassessors' },
  { name: 'Instagram', icon: 'instagram', url: 'https://www.instagram.com/efqmassessors_dubai' },
  { name: 'Facebook', icon: 'facebook', url: 'https://www.facebook.com/profile.php?id=61581708177728' },
]
